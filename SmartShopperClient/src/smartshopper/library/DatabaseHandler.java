...
public class DatabaseHandler extends SQLiteOpenHelper {
	...
	// Database Name
	private static final String DATABASE_NAME = "smartshopper_login";
	...
	// Retrive the user from the database and populate the hashmap with data
	// when called.
